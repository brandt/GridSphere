...
public class PortletServlet  extends HttpServlet
    ...
    public void dummy(HttpServletRequest request, HttpServletResponse response) {
        ...
        /*
        org.gridlab.gridsphere.portlet.PortletRequest portletRequest = new SportletRequestImpl(request);
        org.gridlab.gridsphere.portlet.PortletResponse portletResponse = new SportletResponse(response, portletRequest);
        ...
        org.gridlab.gridsphere.portlet.Portlet.Mode mode = request.getMode();
        if (mode == null) {
        mode = org.gridlab.gridsphere.portlet.Portlet.Mode.VIEW;
        ...
        switch (mode.getMode()) {
        case org.gridlab.gridsphere.portlet.Portlet.Mode.VIEW_MODE:
        doView(request, response);
        break;
        case org.gridlab.gridsphere.portlet.Portlet.Mode.EDIT_MODE:
        doEdit(request, response);
        break;
        case org.gridlab.gridsphere.portlet.Portlet.Mode.CONFIGURE_MODE:
        ...
        request.setMode(org.gridlab.gridsphere.portlet.Portlet.Mode.VIEW);
        doView(request, response);
        } else {
        doConfigure(request, response);
        }
        break;
        case org.gridlab.gridsphere.portlet.Portlet.Mode.HELP_MODE:
