...
public class ListBoxItemTagImpl extends BaseComponentTagImpl implements ListBoxItemTag {
     ...
     */
    protected boolean itemExists(ListBoxTagImpl listboxTag) {
     ...
     */
    protected void checkSelectedEntries(ListBoxTagImpl listboxTag) {
        if (selected) {
    ...
    public int doEndTag() throws JspException {
        ...
        ListBoxTagImpl listboxTag = (ListBoxTagImpl) getParent();
        if (listboxTag != null) {
