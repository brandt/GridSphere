...
public class GridSpherePortletBean {
    ...
    public GridSpherePortletBean() {
    }

    public GridSpherePortletBean(PortletConfig config, PortletRequest request, PortletResponse response)
