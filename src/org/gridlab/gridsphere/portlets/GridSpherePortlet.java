...
public class GridSpherePortlet extends AbstractPortlet {

    private String portletBeanName = null;
    private Class portletBeanClass = GridSpherePortletBean.class;
    ...
    public void actionPerformed(ActionEvent event) throws PortletException {
        ...
        GridSpherePortletBean portletBean = getPortletBean(request, response);
        // Set action event
    ...
    private GridSpherePortletBean getPortletBean(PortletRequest request, PortletResponse response)
            throws PortletException {
        PortletLog log = getPortletLog();
        log.debug("Entering getPortletBean()");
        String portletBeanName = getPortletBeanName();
        log.debug("Getting " + portletBeanName);
        GridSpherePortletBean portletBean =
                (GridSpherePortletBean)request.getAttribute(portletBeanName);
        ...
        if (portletBean == null) {
            ...
            try {
                portletBean = (GridSpherePortletBean)this.portletBeanClass.newInstance();
