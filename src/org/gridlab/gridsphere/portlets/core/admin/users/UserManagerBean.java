...
public class UserManagerBean extends ActionEventHandler {
    ...
    public static final String DO_VIEW_USER_LIST = "/jsp/admin/users/doViewUserList.jsp";
    public static final String DO_VIEW_USER_VIEW = "/jsp/admin/users/doViewUserView.jsp";
    public static final String DO_VIEW_USER_EDIT = "/jsp/admin/users/doViewUserEdit.jsp";
    public static final String DO_VIEW_USER_DELETE = "/jsp/admin/users/doViewUserDelete.jsp";
    public static final String DO_VIEW_USER_DELETE_CONFIRM = "/jsp/admin/users/doViewUserDeleteConfirm.jsp";
    ...
    public void doViewNewUser()
            throws PortletException {
        editUser();
        setTitle("User Account Manager [New User]");
        setPage(DO_VIEW_USER_EDIT);
    }

    public void doViewEditUser()
            throws PortletException {
        loadUser();
        editUser();
    ...
    public void doViewConfirmEditUser()
            throws PortletException {
        loadUser();
        updateUser();
        try {
    ...
    public void doViewCancelEditUser()
            throws PortletException {
        doViewListUser();
    }

    public void doViewDeleteUser()
            throws PortletException {
        loadUser();
        viewUser();
        setTitle("User Account Manager [Delete User]");
        setPage(DO_VIEW_USER_DELETE);
    }

    public void doViewConfirmDeleteUser()
            throws PortletException {
        loadUser();
        viewUser();
        deleteUser();
        setTitle("User Account Manager [Deleted User]");
        setPage(DO_VIEW_USER_DELETE_CONFIRM);
    }

    public void doViewCancelDeleteUser()
            throws PortletException {
        doViewListUser();
    }
    ...
    private void viewUserList() {
        log.debug("Entering viewUserList()");
        ...
        if (this.userList.size() == 0) {
            ...
            while (userIterator.hasNext()) {
                ...
                ActionLinkBean userNameLinkBean
                        = new ActionLinkBean(createPortletURI(), "doViewViewUser", user.getUserName());
        ...
        log.debug("Exiting viewUserList()");
    }
