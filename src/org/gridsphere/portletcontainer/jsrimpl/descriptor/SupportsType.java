...
public class SupportsType implements java.io.Serializable {
     ...
     * Field _mimeType
     */
    private org.gridsphere.portletcontainer.jsrimpl.descriptor.MimeType _mimeType;
     ...
     * @param vPortletMode
     */
    public void addPortletMode(org.gridsphere.portletcontainer.jsrimpl.descriptor.PortletMode vPortletMode)
     ...
     * @param vPortletMode
     */
    public void addPortletMode(int index, org.gridsphere.portletcontainer.jsrimpl.descriptor.PortletMode vPortletMode)
            throws java.lang.IndexOutOfBoundsException {
     ...
     * @param vWindowState
     */
    public void addWindowState(org.gridsphere.portletcontainer.jsrimpl.descriptor.WindowState vWindowState)
            throws java.lang.IndexOutOfBoundsException {
     ...
     * @param vWindowState
     */
    public void addWindowState(int index, org.gridsphere.portletcontainer.jsrimpl.descriptor.WindowState vWindowState)
            throws java.lang.IndexOutOfBoundsException {
     ...
     */
    public org.gridsphere.portletcontainer.jsrimpl.descriptor.MimeType getMimeType() {
     ...
     * @param index
     */
    public org.gridsphere.portletcontainer.jsrimpl.descriptor.WindowState getWindowState(int index)
            throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.gridsphere.portletcontainer.jsrimpl.descriptor.WindowState) _windowStateList.get(index);
    } //-- org.gridsphere.portletcontainer.jsr.descriptor.WindowState getWindowState(int)

    /**
     * Method getWindowState
     */
    public org.gridsphere.portletcontainer.jsrimpl.descriptor.WindowState[] getWindowState() {
        int size = _windowStateList.size();
        org.gridsphere.portletcontainer.jsrimpl.descriptor.WindowState[] mArray = new org.gridsphere.portletcontainer.jsrimpl.descriptor.WindowState[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (org.gridsphere.portletcontainer.jsrimpl.descriptor.WindowState) _windowStateList.get(index);
        }
        return mArray;
     ...
     * @param index
     */
    public org.gridsphere.portletcontainer.jsrimpl.descriptor.PortletMode getPortletMode(int index)
            throws java.lang.IndexOutOfBoundsException {
        //-- check bounds for index
        ...
        return (org.gridsphere.portletcontainer.jsrimpl.descriptor.PortletMode) _portletModeList.get(index);
    } //-- org.gridsphere.portletcontainer.jsr.descriptor.PortletMode getPortletMode(int)

    /**
     * Method getPortletMode
     */
    public org.gridsphere.portletcontainer.jsrimpl.descriptor.PortletMode[] getPortletMode() {
        int size = _portletModeList.size();
        org.gridsphere.portletcontainer.jsrimpl.descriptor.PortletMode[] mArray = new org.gridsphere.portletcontainer.jsrimpl.descriptor.PortletMode[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (org.gridsphere.portletcontainer.jsrimpl.descriptor.PortletMode) _portletModeList.get(index);
        }
        return mArray;
     ...
     * @param vPortletMode
     */
    public boolean removePortletMode(org.gridsphere.portletcontainer.jsrimpl.descriptor.PortletMode vPortletMode) {
     ...
     * @param vWindowState
     */
    public boolean removeWindowState(org.gridsphere.portletcontainer.jsrimpl.descriptor.WindowState vWindowState) {
     ...
     */
    public void setMimeType(org.gridsphere.portletcontainer.jsrimpl.descriptor.MimeType mimeType) {
     ...
     * @param vPortletMode
     */
    public void setPortletMode(int index, org.gridsphere.portletcontainer.jsrimpl.descriptor.PortletMode vPortletMode)
            throws java.lang.IndexOutOfBoundsException {
        //-- check bounds for index
        if ((index < 0) || (index > _portletModeList.size())) {
            throw new IndexOutOfBoundsException();
     ...
     */
    public void setPortletMode(org.gridsphere.portletcontainer.jsrimpl.descriptor.PortletMode[] portletModeArray) {
        //-- copy array
        _portletModeList.clear();
     ...
     * @param vWindowState
     */
    public void setWindowState(int index, org.gridsphere.portletcontainer.jsrimpl.descriptor.WindowState vWindowState)
            throws java.lang.IndexOutOfBoundsException {
        //-- check bounds for index
        if ((index < 0) || (index > _windowStateList.size())) {
            throw new IndexOutOfBoundsException();
     ...
     */
    public void setWindowState(org.gridsphere.portletcontainer.jsrimpl.descriptor.WindowState[] windowStateArray) {
        //-- copy array
        _windowStateList.clear();
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
            throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.gridsphere.portletcontainer.jsrimpl.descriptor.SupportsType) Unmarshaller.unmarshal(org.gridsphere.portletcontainer.jsrimpl.descriptor.SupportsType.class, reader);
