...
import org.gridsphere.portletcontainer.jsrimpl.descriptor.types.ReadOnlyType;
...
public class PreferenceType implements java.io.Serializable {
     ...
     * Field _readOnly
     */
    private org.gridsphere.portletcontainer.jsrimpl.descriptor.types.ReadOnlyType _readOnly;
     ...
     * @param vValue
     */
    public void addValue(org.gridsphere.portletcontainer.jsrimpl.descriptor.Value vValue)
     ...
     * @param vValue
     */
    public void addValue(int index, org.gridsphere.portletcontainer.jsrimpl.descriptor.Value vValue)
            throws java.lang.IndexOutOfBoundsException {
     ...
     */
    public org.gridsphere.portletcontainer.jsrimpl.descriptor.types.ReadOnlyType getReadOnly() {
     ...
     * @param index
     */
    public org.gridsphere.portletcontainer.jsrimpl.descriptor.Value getValue(int index)
            throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.gridsphere.portletcontainer.jsrimpl.descriptor.Value) _valueList.get(index);
    } //-- org.gridsphere.portletcontainer.jsr.descriptor.Value getValue(int)

    /**
     * Method getValue
     */
    public org.gridsphere.portletcontainer.jsrimpl.descriptor.Value[] getValue() {
        int size = _valueList.size();
        org.gridsphere.portletcontainer.jsrimpl.descriptor.Value[] mArray = new org.gridsphere.portletcontainer.jsrimpl.descriptor.Value[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (org.gridsphere.portletcontainer.jsrimpl.descriptor.Value) _valueList.get(index);
        }
        return mArray;
     ...
     * @param vValue
     */
    public boolean removeValue(org.gridsphere.portletcontainer.jsrimpl.descriptor.Value vValue) {
     ...
     */
    public void setReadOnly(org.gridsphere.portletcontainer.jsrimpl.descriptor.types.ReadOnlyType readOnly) {
     ...
     * @param vValue
     */
    public void setValue(int index, org.gridsphere.portletcontainer.jsrimpl.descriptor.Value vValue)
            throws java.lang.IndexOutOfBoundsException {
        //-- check bounds for index
        if ((index < 0) || (index > _valueList.size())) {
            throw new IndexOutOfBoundsException();
     ...
     * @param valueArray
     */
    public void setValue(org.gridsphere.portletcontainer.jsrimpl.descriptor.Value[] valueArray) {
        //-- copy array
        _valueList.clear();
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
            throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.gridsphere.portletcontainer.jsrimpl.descriptor.PreferenceType) Unmarshaller.unmarshal(org.gridsphere.portletcontainer.jsrimpl.descriptor.PreferenceType.class, reader);
