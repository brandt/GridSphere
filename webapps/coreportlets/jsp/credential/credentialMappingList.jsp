...
<form name="CredentialMappingPortlet" method="POST"
      action="<%=credentialManagerBean.getPortletActionURI(CredentialManagerBean.ACTION_CREDENTIAL_MAPPING_LIST)%>">
  <input type="hidden" name="credentialMappingID" value=""/>
  <script type="text/javascript">
    function CredentialMappingPortlet_listCredentialMapping_onClick() {
      document.CredentialMappingPortlet.action="<%=credentialManagerBean.getPortletActionURI(CredentialManagerBean.ACTION_CREDENTIAL_MAPPING_LIST)%>";
    ...
    function CredentialMappingPortlet_newCredentialMapping_onClick(credentialMappingID) {
      ...
      document.CredentialMappingPortlet.action="<%=credentialManagerBean.getPortletActionURI(CredentialManagerBean.ACTION_CREDENTIAL_MAPPING_EDIT)%>";
      document.CredentialMappingPortlet.submit();
    }
    ...
    function CredentialMappingPortlet_viewCredentialMapping_onClick(credentialMappingID) {
      ...
      document.CredentialMappingPortlet.action="<%=credentialManagerBean.getPortletActionURI(CredentialManagerBean.ACTION_CREDENTIAL_MAPPING_VIEW)%>";
      document.CredentialMappingPortlet.submit();
    }
  </script>
<table class="portlet-pane" cellspacing="1">
      ...
      <table class="portlet-frame" cellspacing="1" width="100%">
        ...
        <tr>
          <td class="portlet-frame-actions">
            <input type="button"
                   name="<%=CredentialManagerBean.ACTION_CREDENTIAL_MAPPING_LIST%>"
                   value="List Mappings"
                   onClick="javascript:CredentialMappingPortlet_listCredentialMapping_onClick()"/>
            &nbsp;&nbsp;<input type="button"
                   name="<%=CredentialManagerBean.ACTION_CREDENTIAL_MAPPING_EDIT%>"
                   value="New Mapping"
  ...
  <tr>
    <td>
      <table class="portlet-frame" cellspacing="1" width="100%">
<% List credentialMappingList = credentialManagerBean.getCredentialMappingList();
