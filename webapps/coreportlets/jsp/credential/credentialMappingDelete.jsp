...
<form name="CredentialMappingPortlet" method="POST"
  ...
  <script type="text/javascript">
    function CredentialMappingPortlet_confirmDeleteCredentialMapping_onClick() {
      document.CredentialMappingPortlet.action="<%=credentialMappingBean.getPortletActionURI(CredentialMappingAdminBean.ACTION_CREDENTIAL_MAPPING_DELETE_CONFIRM)%>";
      document.CredentialMappingPortlet.submit();
    }

    function CredentialMappingPortlet_cancelDeleteCredentialMapping_onClick() {
      document.CredentialMappingPortlet.action="<%=credentialMappingBean.getPortletActionURI(CredentialMappingAdminBean.ACTION_CREDENTIAL_MAPPING_DELETE_CANCEL)%>";
      document.CredentialMappingPortlet.submit();
    }
  </script>
