...
<portletAPI:init/>
<gs:form action="doConfigureDeleteUser">
      ...
      <table class="portlet-frame" cellspacing="1" width="100%">
        <tr>
          <td class="portlet-frame-actions">
            <gs:submit name="doConfigureConfirmDeleteUser" value="Confirm Delete"/>
            &nbsp;&nbsp;<gs:submit name="doConfigureCancelDeleteUser" value="Cancel Delete"/>
          </td>
        </tr>
        <tr>
