...
public class PerfUserManager {
    ...
    private static org.gridlab.gridsphere.services.core.security.acl.AccessControlManagerService aclManagerService = null;
    private static org.gridlab.gridsphere.services.core.user.UserManagerService userManager = null;
    ...
    public static void main(String[] args) {
        ...
        try {
            aclManagerService = (org.gridlab.gridsphere.services.core.security.acl.AccessControlManagerService)factory.createPortletService(AccessControlManagerService.class, null, true);
    ...
    private static void perfretrieveAccountRequest() {
        ...
        for (int i=0;i<result.size();i++) {
            AccountRequest ari = (AccountRequest)result.get(i);
        }
        long mystopwatch_stop = System.currentTimeMillis();
        long mystopwatch = mystopwatch_stop-mystopwatch_start;
